...
// Init Razorpay once, after envs are loaded by server.js (import 'dotenv/config' there)
if (!process.env.RAZORPAY_KEY_ID || !process.env.RAZORPAY_KEY_SECRET) {
  console.error('Razorpay envs missing:', {
...
const paymentRazorpay = async (req, res) => {
  try {
        ...
        const currency = (process.env.CURRENCY || 'INR').trim();
